...
<body>
	<div class="container">
		<div id=main_div>
			<span id="main_text">商店情報入力</span>
			<span class="red_text">*下の必須入力事項をすべて入力してください。</span>
		</div>
		<form method="post" action="write.do">
			<div class="text_div">
				...
				<span>
					<input type="text" name="no" value="${subReq.no }" <%=a%> required />
				</span>
				<c:if test="${errors.no }">号室を入力してください。</c:if>
			</div>
			<div class="text_div">
				<span class="red_text">*</span>
				<span class="text_id">管理人 名前</span>
				<span>
					<input type="text" name="name" value="${subReq.no }" <%=a%> required />
				</span>
				<c:if test="${errors.no }">号室を入力してください。</c:if>
			</div>
			<div class="text_div">
				...
				<span>
					<input type="text" name="hire" value="${subReq.no }" <%=a%> required />
				</span>
				<c:if test="${errors.no }">号室を入力してください。</c:if>
			</div>
			<div class="text_div">
				...
				<span>
					<input type="text" name="lease" value="${subReq.no }" <%=a%> required />
				</span>
				<c:if test="${errors.no }">号室を入力してください。</c:if>
			</div>
			<div class="text_div">
				...
				<span>
					<input type="text" name="rent_fee" value="${subReq.no }" <%=a%> required />
				</span>
				<c:if test="${errors.no }">号室を入力してください。</c:if>
			</div>
			<div class="text_div">
				...
				<span>
					<input type="text" name="period" value="${subReq.no }" <%=a%> required />
				</span>
				<c:if test="${errors.no }">号室を入力してください。</c:if>
			</div>
			<div class="text_div">
				...
				<span>
					<input type="text" name="size" value="${subReq.no }" <%=a%> required />
				</span>
				<c:if test="${errors.no }">号室を入力してください。</c:if>
			</div>
			<div class="text_div">
				...
				<span>
					<input type="date" name="coming" value="${subReq.no }" <%=a%> required />
				</span>
				<c:if test="${errors.no }">号室を入力してください。</c:if>
			</div>
			...
			<div class="hidden">
				...
				<span>
					<input type="date" name="leaving" value="2000-01-01" <%=a%> />
				</span>
				<c:if test="${errors.no }">号室を入力してください。</c:if>
			</div>
